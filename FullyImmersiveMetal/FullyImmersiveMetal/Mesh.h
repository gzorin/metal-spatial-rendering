...
public:
    ...
    virtual void draw(id<MTLRenderCommandEncoder> renderCommandEncoder, const PoseConstants *poseConstants, int instanceCount) = 0;
...
public:
    ...
    void draw(id<MTLRenderCommandEncoder> renderCommandEncoder, const PoseConstants *poseConstants, int instanceCount) override;
